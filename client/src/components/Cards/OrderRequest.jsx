...
export default function OrderRequest() {
  return (
    <>
      <div className="relative flex flex-col min-w-0 break-words bg-white rounded-md h-96 w-full mb-6 shadow-lg rounded">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle font-bold text-red-500 border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  PENDING
                </td>
